...
While messing with this I'm also applying some small tweaks to the UI.  Of course having AI refactor these things, sometimes it takes a couple of prompts but it gets the job done, lol.
